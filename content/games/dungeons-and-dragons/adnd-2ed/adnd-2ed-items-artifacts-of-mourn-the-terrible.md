...
draft: true
---
**<u>MISCELLANEOUS MAGIC ITEMS</u>**

**<u>Artifacts of Mourn The Terrible</u>**
...
> **Sword, Velkyn**: This was the first weapon forged and enchanted by
...
01-10 When the sword is swung it slices clean through whatever it was
swung at.
...
> **Sword, Abbil**: This was the second sword created by Mourn, but like
...
19-25 Control Weather. A storm cloud appears above the user and rains
heavily on him for 1D8 rounds.
...
> **Weapon of Adaptability, Brorna**: This was the third item of this
...
01-10 User absorbs double the hit points that were caused much like the
wizard spell Vampiric Touch.

11-18 Two Lightning bolts fly from the tip to strike any targets in
front of the wielder. Cast as Wand.

19-25 A meteor swarm spell targeted by the user. Cast as per a wizard of
24th level.

26-30 Any plants in a 50' radius catch on fire and burn for 1D20 turns
at the end of which they return to normal as if it never happened.

31-33 The target convulses on the spot for 1D20 turns.

34-36 The target that is touched by the weapon is immediately turned to
stone.
...
91-95 User is teleported 20' in any direction unless destination is
specified.

96-00 User becomes invulnerable to all attacks except wish spells for
the next 1D4 rounds.
...
> **Weapon of Adaptability, Velve**: Again like the first three weapons
...
> **Weapon of Might, Ultrinnan**: Again the weapon failed to meet the
...
Communication: Speech & Telepathy Intelligence: 17

Alignment: Chaotic Neutral Ego: 22

Languages: All Personality rating: 39

Primary Abilities: Extraordinary Abilities:

-Sixth Sense -Destruction once daily

-Know Alignment -Heal once per day
...
01-10 If weapon is a sword then when it is swung it cuts clean through
whatever it was swung at.

11-12 Two Lightning bolts fly from the tip to strike any targets in
front of the wielder. Cast as Wand.

13-14 User is 50% Magic Resistant for 1D20 rounds

15-16 The target that is touched by the sword is immediately turned to
stone.
...
21-22 User is put into temporal stasis for specified time, if no time
limit is specified weapon decides.
...
31-32 Flower Strike. Flowers grow from the wounded victims wound causing
extreme pain and 1D10 extra points of damage.

33-34 User gains half the hit points of damage that he causes to the
target as per the Vampiric Ring of Regeneration.

35-36 Minor Globe of Invulnerability as per a 20th level mage centered
on the user.
...
> **Mystic Bracers, Blitz and Aegis**: Like all of Mourns items these
...
│ **D100** │ **Table 2: Spells** │ There is a chance that the

├────────┼──────────────────────┤ bracers will function

│ **Roll** │ **Spell** │ properly, but it is slim.

├────────┼──────────────────────┤

│ 01-05 │ Magic Missile │ DM's Note: Roll 1D100

│ 06-15 │ Charm Person │ after the player has

│ 16-23 │ Feather Fall │ stated what function he

│ 24-31 │ Shocking Grasp │ wishes to use. If the

│ 32-35 │ Burning Hands │ control roll succeeds the

│ 36-43 │ Fireball │ action actually happens

│ 44-46 │ Wall of Force │ properly. If it is

│ 47-56 │ Detect Magic │ between doesn't then

│ 57-61 │ Darkness 15' Radius │ roll randomly on the

│ 62-65 │ Lightning Bolt │ chart.

│ 66-70 │ Levitate │

│ 71-73 │ Pyrotechnics │ All spells are cast at

│ 74-80 │ Invisibility │ 20th level ability.
...
**Mystic Bracers, Z,ress and Sargh**: These bracers are like all Mourn's
...
The left bracer has the following abilities: 1) store and retrieve
weapons as a bracelet of readiness, 2) store three types of shields, and
...
If both bracers are worn together the following abilities are also
conferred: 1) raises wearers strength to 25, 2) lowers armour class to
zero, and 3) gives +1 to initiative.

**Mystic Bracers, Dracoth and Faer**: These were Mourns Third attempt at
...
The left bracer has the following powers: 1) confers an armour class of
zero, 2) can be used to cast various transportation spells, and 3)
detects magic same as wizard spell.

**D100 Random Transportation**
...
**Mystic Bracers, Elgg and Kyorl**: When Mourn enchanted these bracers
